...
public class TutorSearchBySkill extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutor_search_by_skill);
        setTitle("Search Tutor By Skill");
    ...
    private void getAllTutorList() {
        ...
        String url3=Config.baseUrl2+"TM_Script/getTutorListBySkill.php?value="+inputSearchWild.getText().toString();
        StringRequest stringRequest3 = new StringRequest(Request.Method.GET, url3, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray courseArray = jsonObject.getJSONArray("resultSkill");
                    ...
                    for (int j = 0; j < size2; j++) {
                        ...
                        slot.put("skill",skill);
                        tutorList.add(slot);
                    }
                    //inputSearch.setText(tutorList.toString());
                    // tutorList = new ArrayList<HashMap<String, String>>(tutorList);
                    listAdaptrTutor = new SimpleAdapter(getApplicationContext(), tutorList, R.layout.list_tutor_skill_search,
                            new String[]{"skill","name","email","landmark"}, new int[]{R.id.tutor_skill,R.id.tutor_name,R.id.tutor_email,R.id.tutor_landmark});
