...
public class SelectStudentByTutor extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_student_by_tutor);
    ...
    private void sendToStudentProfile() {
        ...
        String urlUpdate = Config.baseUrl2 + "TM_Script/studentSelectByTutor.php";
